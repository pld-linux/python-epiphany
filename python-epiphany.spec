...
# Source0-md5:	b2444da46bd920b1acfa364fd790ab9b
...
rm $RPM_BUILD_ROOT%{_libdir}/epiphany-1.5/loaders/lib*.la
...
%attr(755,root,root) %{_libdir}/epiphany-1.5/loaders/lib*.so*
%{_libdir}/epiphany-1.5/extensions/*.py
%{_libdir}/epiphany-1.5/extensions/*.xml
